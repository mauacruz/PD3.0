...
var
  WebModuleClass: TComponentClass = TWebContato;
...
procedure TWebContato.WebModuleCreate(Sender: TObject);
begin
  ...
  FMVC.AddController(TContatoController);
...
procedure TWebContato.WebModuleDestroy(Sender: TObject);
begin
  FMVC.Free;
end;
